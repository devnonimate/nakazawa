...
const TargetingCategoriesConfig = ({ selectedEmpresa }) => {
  ...
  const campaignFields = [
    { id: 'broadtargetingcategories', description: 'Lista das categorias de segmentação ampla que estão disponíveis para a conta.' }
  ];
  ...
  const handleGenerate = async () => {
    ...
    try {
      const url = new URL(`${config.API_URL}/api/targeting-categories`);
...
export default TargetingCategoriesConfig;
