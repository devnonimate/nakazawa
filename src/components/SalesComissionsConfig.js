...
const SalesComissionsConfigConfig = ({ selectedEmpresa }) => {
  ...
  const handleSubmit = () => {
    ...
    const url = `${config.API_URL}/api/comissions-sales?${params.toString()}`;
...
export default SalesComissionsConfigConfig;
